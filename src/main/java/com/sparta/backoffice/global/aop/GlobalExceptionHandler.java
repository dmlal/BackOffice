...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<BaseResponse<String>> runtimeExceptionHandler(RuntimeException ex) {
	...
	public ResponseEntity<BaseResponse<String>> apiExceptionHandler(ApiException ex) {
		log.error("Runtime Exceptions :", ex);
